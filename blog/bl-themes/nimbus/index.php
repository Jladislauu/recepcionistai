...
<head>
  ...
  <script>(function (w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-K79ZF8WP');</script>
...
<body class="blog<?php if ($WHERE_AM_I == 'page') {
  echo '-details';
} ?>-page" data-bs-spy="scroll" data-bs-target="#navmenu">

  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K79ZF8WP" height="0" width="0"
  ...
  <main id="main">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            <?php
            if ($WHERE_AM_I != 'home') {
              echo '<li><a href="' . $site->url() . '">Home</a></li>';
            }
            if ($WHERE_AM_I == 'page') {
    ...
    <section id="blog<?php if ($WHERE_AM_I == 'page') {
      echo '-details';
    } ?>" class="blog<?php if ($WHERE_AM_I == 'page') {
       echo '-details';
     } ?>">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>&copy; <span>Copyright</span> <?php echo date('Y'); ?> <strong><a href="<?php echo $site->url(); ?>"
            class="fw-bold"><?php echo $site->title(); ?></a></strong>; <span>All Rights Reserved</span></p>
      <div class="credits">
        Powered by <a href="https://www.bludit.com" class="fw-bold" target="_blank">Bludit</a> - Theme by <a
          href="https://bluditlab.com/themes/technology/nimbus" class="fw-bold" target="_blank">BluditLab</a>
      </div>
    </div>
  </footer>
