...
<head>
    ...
    <title>Installation | RecepcionistAI</title>
...
<header>
    <div class="container">
        <h1 class="page-title">RecepcionistAI Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the RecepcionistAI installation page.</h3>
        <p>
            This page will help you set the main settings of your RecepcionistAI installation. You will be able to
            ...
            If you face any problems during the usage of RecepcionistAI you can always check the
            <a href="https://recepcionistai.com/docs.html">Documentation</a> and
    ...
    <div class="mb-2">
        <h3>License</h3>
        RecepcionistAI is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
        of RecepcionistAI in any way <br> you agree with the terms described in the following url:
    ...
    <button type="button" id="install" class="btn btn-primary">
        ...
        Install RecepcionistAI
    </button>
</div>

<footer>
    Fornecido Por <a href="https://recepcionistai.com">RecepcionistAI</a>
</footer>
